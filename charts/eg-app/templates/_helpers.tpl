...
environment: {{ .Values.environment.labels.environment | default "unknown" }}
team: {{ .Values.environment.labels.team | default "unknown" }}
{{- end }}
...
{{- default (include "eg-app.fullname" .) .Values.security.serviceAccount.name }}
{{- else }}
